                    ...
                    <>
                              ...
                              <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 font-nato backdrop-blur-sm">
                                        <div className="bg-gray-950 p-6 rounded-lg shadow-lg max-w-sm w-80 relative">
                                                  ...
                                                  <button onClick={reg} className="absolute  top-7 right-4 z-10"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#eab308"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" /></svg></button>
...
{/** we use this to display error */}            {error && (
                                                  ...
                                                  <button className="bg-yellow-500 text-white w-full py-4 mt-4 rounded-md" type="button" onClick={()=>{pass1!=pass2 ? setError("پاسوردەکەوەکویەک نیە"): null}}>تۆمارکردن</button>
